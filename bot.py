...
import telebot # стандартная библиотека для работы с чат ботами
import pyqrcode # библиотека для создания qr-кода
from telebot import types # для создания клавиатуры и прочего

token="token" # токен для доступа к боту
